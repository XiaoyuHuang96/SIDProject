...
solver.cuda()
solver.restore_models(time_string='201904081011', epoch='3990')
...
sony_train_dataset=OthersDataset.OthersDataset(input_dir = '/home/huangxiaoyu/dataset/Sony/short/',gt_dir = '/home/huangxiaoyu/dataset/Sony/long/',ps=512,type='test')
