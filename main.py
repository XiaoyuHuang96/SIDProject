...
from dataset import FujiDataset,SonyDataset,TrainDataset,OthersDataset
...
sony_train_dataset=OthersDataset.OthersDataset(input_dir = '/home/huangxiaoyu/dataset/Sony/short/',gt_dir = '/home/huangxiaoyu/dataset/Sony/long/',ps=512,type='train')
sony_train_dataloader=Data.DataLoader(dataset=sony_train_dataset,batch_size=1,shuffle=True,num_workers=4)
